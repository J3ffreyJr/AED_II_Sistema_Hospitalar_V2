...
public class NoListaDuplamenteLigada {
    ...
    public NoListaDuplamenteLigada getProximo() {
        return proximo;
    }

    public void setProximo(NoListaDuplamenteLigada proximo) {
        this.proximo = proximo;
    }

    public NoListaDuplamenteLigada getAnterior() {
        return anterior;
    }

    public void setAnterior(NoListaDuplamenteLigada anterior) {
